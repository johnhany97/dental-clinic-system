...
public class HealthPlan {
	 ...
	 * @param price
	 *            Price of the health plan
	 * @param checkUpLevel
	 *            check up numbers of treatments of the health plan
	 * @param hygieneLevel
	 *            hygiene number of treatments of the health plan
	 * @param repairLevel
	 *            repair work number of treatments of the health plan
	 * @throws CommunicationsException
	 *             when an error occurs whilst attempting connection
	 * @throws MySQLIntegrityConstraintViolationException
	 *             if health plan name already exists
	 * @throws SQLException
	 ...
	 * 
	 * @param name
	 *            Name of treatment to be searched
	 * @throws CommunicationsException
	 *             when an error occurs whilst attempting connection
	 * @throws SQLException
	 *             for any other error, could be incorrect parameters.
	...
	public HealthPlan(String name) throws CommunicationsException, SQLException {
		...
		try {
			ResultSet rs = DBQueries.execQuery("SELECT * FROM HealthPlans WHERE name = '" + name + "'", conn);
			if (rs.next()) {
	...
	public void setName(String name)
		...
		DBQueries.execUpdate("UPDATE HealthPlans SET Name = '" + name + "' WHERE Name = '" + this.name + "'");
		this.name = name;
	}
	...
	public void setPrice(double price) throws CommunicationsException, SQLException {
		DBQueries.execUpdate("UPDATE HealthPlans SET Price = '" + price + "' WHERE Name = '" + this.name + "'");
		this.price = price;
	}
	 ...
	 * 
	 * @param checkUpLevel
	 *            The new check up level of a HealthPlan.
	 * @throws CommunicationsException
	 *             when an error occurs whilst attempting connection
	 * @throws SQLException
	 *             for any other error, could be incorrect parameters.
	...
	public void setCheckUpLevel(int checkUpLevel) throws CommunicationsException, SQLException {
		DBQueries.execUpdate(
				"UPDATE HealthPlans SET CheckUpLevel = '" + checkUpLevel + "' WHERE Name = '" + this.name + "'");
		this.checkUpLevel = checkUpLevel;
	}
	 ...
	 * 
	 * @param hygieneLevel
	 *            The new hygiene level of a health plan.
	 * @throws CommunicationsException
	 *             when an error occurs whilst attempting connection
	 * @throws SQLException
	 *             for any other error, could be incorrect parameters.
	...
	public void setHygieneLevel(int hygieneLevel) throws CommunicationsException, SQLException {
		DBQueries.execUpdate(
				"UPDATE HealthPlans SET HygieneLevel = '" + hygieneLevel + "' WHERE Name = '" + this.name + "'");
		this.hygieneLevel = hygieneLevel;
	}
	 ...
	 * 
	 * @param repairLevel
	 *            The new repair level of a health plan.
	 * @throws CommunicationsException
	 *             when an error occurs whilst attempting connection
	 * @throws SQLException
	 *             for any other error, could be incorrect parameters.
	...
	public void setRepairLevel(int repairLevel) throws CommunicationsException, SQLException {
		DBQueries.execUpdate(
				"UPDATE HealthPlans SET RepairLevel = '" + repairLevel + "' WHERE Name = '" + this.name + "'");
		this.repairLevel = repairLevel;
	}
