...
public class Patient {
	...
	public Patient(String title, String firstName, String lastName, LocalDate dateOfBirth, String phoneNumber,
		...
		try {
			...
			if (!dbHasPatient(firstName, houseNumber, postcode)) {
				DBQueries.execUpdate("INSERT INTO Patients Values(" + patientID + ", '" + title + "', '" + firstName
						+ "', '" + lastName + "', '" + dateOfBirth + "', '" + phoneNumber + "', '" + houseNumber
						+ "', '" + postcode + "')");
			} else {
				throw new MySQLIntegrityConstraintViolationException("A patient with first name " + firstName
						+ " house number " + houseNumber + " and postcode " + postcode + " already exists.");
			}
		} finally {
			conn.close();
		}
	...
	public Patient(String firstName, String houseNumber, String postcode) throws CommunicationsException, SQLException {
		Connection conn = Database.getConnection();
		try {
			ResultSet rs = DBQueries.execQuery("SELECT * FROM Patients WHERE  FirstName Like '%" + firstName
					+ "%' AND HouseNumber LIKE '%" + houseNumber + "%' AND Postcode LIKE '%" + postcode + "%'", conn);
			if (rs.next()) {
	...
	/**
	 * This constructor should be called when searching for a particular patient by
	 * ID.
	 * 
	 * @param patientId
	 ...
	 * 
	 * @param patientID
	 *            The new patientID of the patient.
	 * @throws CommunicationsException
	 *             when an error occurs whilst attempting connection
	 * @throws SQLException
	 *             for any other error, could be incorrect parameters.
	 * @throws MySQLIntegrityConstraintViolationException
	 *             if patientID already exists
	 */
	public void setPatientID(int patientID)
			throws CommunicationsException, MySQLIntegrityConstraintViolationException, SQLException {
		DBQueries.execUpdate("UPDATE Patients SET PatientID = '" + patientID + "' WHERE FirstName = '" + firstName
				+ "' AND HouseNumber = '" + houseNumber + "' AND Postcode = '" + postcode + "'");
	...
	public void setTitle(String title) throws CommunicationsException, SQLException {
		DBQueries.execUpdate("UPDATE Patients SET Title = '" + title + "' WHERE FirstName = '" + this.firstName
				+ "' AND HouseNumber = '" + houseNumber + "' AND Postcode = '" + postcode + "'");
		this.title = title;
	}
	 ...
	 * 
	 * @param firstName
	 *            The new first name of a patient.
	 * @throws CommunicationsException
	 *             when an error occurs whilst attempting connection
	 * @throws SQLException
	 *             for any other error, could be incorrect parameters.
	...
	public void setFirstName(String firstName) throws CommunicationsException, SQLException {
		DBQueries.execUpdate("UPDATE Patients SET FirstName = '" + firstName + "' WHERE FirstName = '" + this.firstName
				+ "' AND HouseNumber = '" + houseNumber + "' AND Postcode = '" + postcode + "'");
		this.firstName = firstName;
	}
	 ...
	 * 
	 * @param lastName
	 *            The new last name of a patient.
	 * @throws CommunicationsException
	 *             when an error occurs whilst attempting connection
	 * @throws SQLException
	 *             for any other error, could be incorrect parameters.
	...
	public void setLastName(String lastName) throws CommunicationsException, SQLException {
		DBQueries.execUpdate("UPDATE Patients SET LastName = '" + lastName + "' WHERE FirstName = '" + firstName
				+ "' AND HouseNumber = '" + houseNumber + "' AND Postcode = '" + postcode + "'");
		this.lastName = lastName;
	}
	 ...
	 * 
	 * @param dateOfBirth
	 *            The new date of birth of a patient.
	 * @throws CommunicationsException
	 *             when an error occurs whilst attempting connection
	 * @throws SQLException
	 *             for any other error, could be incorrect parameters.
	...
	public void setDateOfBirth(LocalDate dateOfBirth) throws CommunicationsException, SQLException {
		DBQueries.execUpdate("UPDATE Patients SET DateOfBirth = '" + dateOfBirth + "' WHERE FirstName = '" + firstName
				+ "' AND HouseNumber = '" + houseNumber + "' AND Postcode = '" + postcode + "'");
		this.dateOfBirth = dateOfBirth;
	}
	 ...
	 * 
	 * @param phoneNumber
	 *            The new phone Number of a patient.
	 * @throws CommunicationsException
	 *             when an error occurs whilst attempting connection
	 * @throws SQLException
	 *             for any other error, could be incorrect parameters.
	...
	public void setPhoneNumber(String phoneNumber) throws CommunicationsException, SQLException {
		DBQueries.execUpdate("UPDATE Patients SET PhoneNumber = '" + phoneNumber + "' WHERE FirstName = '" + firstName
				+ "' AND HouseNumber = '" + houseNumber + "' AND Postcode = '" + postcode + "'");
		this.phoneNumber = phoneNumber;
	}
	 ...
	 * 
	 * @param houseNumber
	 *            The new house number of a patient.
	 */
	public void setHouseNumber(String houseNumber) throws CommunicationsException, SQLException {
		DBQueries.execUpdate("UPDATE Patients SET HouseNumber = '" + houseNumber + "' WHERE FirstName = '" + firstName
				+ "' AND HouseNumber = '" + this.houseNumber + "' AND Postcode = '" + postcode + "'");
		this.houseNumber = houseNumber;
	}
	...
	public void setPostcode(String postcode) throws CommunicationsException, SQLException {
		DBQueries.execUpdate("UPDATE Patients SET Postcode = '" + postcode + "' WHERE FirstName = '" + firstName
				+ "' AND HouseNumber = '" + houseNumber + "' AND Postcode = '" + this.postcode + "'");
		this.postcode = postcode;
	}
	 ...
	 */
	public void subscribePatient(String healthPlanName)
			throws CommunicationsException, SQLException, MySQLIntegrityConstraintViolationException {
		if (!Usage.hasPatientID(patientID)) {
			this.usage = new Usage(this.patientID, healthPlanName);
		} else {
			throw new MySQLIntegrityConstraintViolationException(
					"A patient with patient id " + patientID + " is already subsrcribed.");
		}
	}
	...
	public static void deletePatient(int patientID) throws SQLException {
		...
		String username;
		try {
			ResultSet rs = DBQueries.execQuery("SELECT * FROM Appointments WHERE  PatientID = '" + patientID + "'",
					conn);
			while (rs.next()) {
				username = rs.getString("Username");
				startTime = rs.getTimestamp("StartDate");
				DBQueries.execUpdate("DELETE FROM AppointmentTreatment WHERE Username = '" + username
						+ "' AND StartDate = '" + startTime.toString() + "'");
			}
