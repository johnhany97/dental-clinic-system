...
public class PatientEditView {
	...
	private void initialize() {
		try {
			...
			saveButton.setFont(new Font("Sans Serif", Font.BOLD, DisplayFrame.FONT_SIZE));
			saveButton.addActionListener(new ActionListener() {
				...
				public void actionPerformed(ActionEvent e) {
					...
					boolean changeAddress = !houseNum.equals(originalHouseNumber)
							|| !streetName.equals(originalStreetName) || !district.equals(originalDistrict)
					...
					boolean changePatient = !title.equals(originalTitle) || !fname.equals(originalFirstName)
							|| !lname.equals(originalLastName) || !phone.equals(originalPhoneNumber)
							|| !date.equals(dob);
					...
					try {
						if (changeAddress) {
							...
							JOptionPane.showMessageDialog(null, "Successfully updated Address", "Success!",
						...
						if (changePatient) {
							...
							if (fname != originalFirstName)
								patient.setFirstName(fname);
							if (lname != originalLastName)
							...
							JOptionPane.showMessageDialog(null, "Successfully updated Patient", "Success!",
									JOptionPane.INFORMATION_MESSAGE);
						}
						if (!changeAddress && !changePatient) {
							JOptionPane.showMessageDialog(null, "Nothing to change", "Message",
									JOptionPane.INFORMATION_MESSAGE);
						}
						// refresh parent
