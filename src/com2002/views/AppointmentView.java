...
public class AppointmentView implements Screen {
	 ...
	 * @param appointment
	 *            Appointment which we are to show details of
	 * @param type
	 *            Representing whether a Doctor (0) or a Secretary (1) are to be
	 *            using this view
	 */
	public AppointmentView(DisplayFrame frame, Appointment appointment, int type) {
		try {
			...
			this.previousAppointments = Schedule.getDoctorAppointmentsByPatient(this.appointment.getUsername(),
					this.patient);
			...
			JOptionPane.showMessageDialog(frame, "Error fetching previous appointments.", "Error",
					JOptionPane.ERROR_MESSAGE);
		}
	}

	/**
	 * Function used to initialize components of this view and add their action
	 * listeners
	 * 
	...
	private void initialize() throws CommunicationsException, SQLException {
		...
		String fullName = this.patient.getTitle() + " " + this.patient.getFirstName() + " "
				+ this.patient.getLastName();
		JLabel patientName = new JLabel(fullName, SwingConstants.LEFT);
		patientName.setFont(new Font("Sans Serif", Font.PLAIN, DisplayFrame.FONT_SIZE));
		...
		appointmentType.setFont(new Font("Sans Serif", Font.BOLD, DisplayFrame.FONT_SIZE / 2));
		...
		dateOfBirthAndAge.setFont(new Font("Sans Serif", Font.PLAIN, DisplayFrame.FONT_SIZE / 2));
		...
		hpLabel.setFont(new Font("Sans Serif", Font.BOLD, DisplayFrame.FONT_SIZE / 2));
		hpPanel.add(hpLabel);
		JLabel checkupLabel = new JLabel(checkupString);
		checkupLabel.setFont(new Font("Sans Serif", Font.PLAIN, DisplayFrame.FONT_SIZE / 2));
		hpPanel.add(checkupLabel);
		JLabel repairLabel = new JLabel(repairString);
		repairLabel.setFont(new Font("Sans Serif", Font.PLAIN, DisplayFrame.FONT_SIZE / 2));
		hpPanel.add(repairLabel);
		JLabel hygieneLabel = new JLabel(hygieneString);
		hygieneLabel.setFont(new Font("Sans Serif", Font.PLAIN, DisplayFrame.FONT_SIZE / 2));
		...
		for (Entry<String, Double> entry : treatments.entrySet()) {
			...
			cb.setFont(new Font("Sans Serif", Font.PLAIN, DisplayFrame.FONT_SIZE / 2));
		...
		finishButton.setFont(new Font("Sans Serif", Font.PLAIN, DisplayFrame.FONT_SIZE / 2));
		finishButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				try {
					...
					e.printStackTrace();
					JOptionPane.showMessageDialog(frame, "Error saving notes", "Error", JOptionPane.ERROR_MESSAGE);
				}
			}
		});
		...
		payButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				try {
					...
					JOptionPane.showMessageDialog(frame, e1.getMessage(), "Check Internet", JOptionPane.ERROR_MESSAGE);
				} catch (SQLException e1) {
		...
		rightPanelLabel.setFont(new Font("Sans Serif", Font.BOLD, DisplayFrame.FONT_SIZE));
		...
		if (this.previousAppointments.size() > 0) { // there are previous appointments
			...
			this.activePreviousAppointmentScrollPane.setBorder(BorderFactory.createCompoundBorder(
			...
			// bottom section consists of list of all this patient's previous appointments
			// if anys
	 ...
	 * 
	 * @param appointment
	 *            Appointment which is to be shown in the card
	 */
	private void addAppointment(Appointment appointment) {
		try {
			...
			String docName = this.appointment.getDoctor().getFirstName() + " "
					+ this.appointment.getDoctor().getLastName();
	...
	private void setOldAppointmentInView(Appointment appointment) throws SQLException {
		...
		aptDay.setFont(new Font("Sans Serif", Font.PLAIN, DisplayFrame.FONT_SIZE / 2));
		aptNotes.setFont(new Font("Sans Serif", Font.PLAIN, DisplayFrame.FONT_SIZE / 2));
		aptType.setFont(new Font("Sans Serif", Font.PLAIN, DisplayFrame.FONT_SIZE / 2));
		aptTreatments.setFont(new Font("Sans Serif", Font.PLAIN, DisplayFrame.FONT_SIZE / 2));
		// titles
		...
		dayTitle.setFont(new Font("Sans Serif", Font.BOLD, DisplayFrame.FONT_SIZE / 2));
		notesTitle.setFont(new Font("Sans Serif", Font.BOLD, DisplayFrame.FONT_SIZE / 2));
		typeTitle.setFont(new Font("Sans Serif", Font.BOLD, DisplayFrame.FONT_SIZE / 2));
		treatmentsTitle.setFont(new Font("Sans Serif", Font.BOLD, DisplayFrame.FONT_SIZE / 2));
		// Add them all
		for (int i = 0; i < 8; i++) {
