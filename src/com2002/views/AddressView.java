...
public class AddressView implements Screen {
	 ...
	 * 
	 * @param frame
	 *            DisplayFrame to show view in
	 * @param address
	 *            Address to show details of
	 */
	...
	private void initialize() throws Exception {
		...
		hNumTitle.setFont(new Font("Sans Serif", Font.BOLD, DisplayFrame.FONT_SIZE / 2));
		sNameTitle.setFont(new Font("Sans Serif", Font.BOLD, DisplayFrame.FONT_SIZE / 2));
		disTitle.setFont(new Font("Sans Serif", Font.BOLD, DisplayFrame.FONT_SIZE / 2));
		cityTitle.setFont(new Font("Sans Serif", Font.BOLD, DisplayFrame.FONT_SIZE / 2));
		postTitle.setFont(new Font("Sans Serif", Font.BOLD, DisplayFrame.FONT_SIZE / 2));
		// Actual data
		...
		hNumLabel.setFont(new Font("Sans Serif", Font.PLAIN, DisplayFrame.FONT_SIZE / 2));
		sNameLabel.setFont(new Font("Sans Serif", Font.PLAIN, DisplayFrame.FONT_SIZE / 2));
		disLabel.setFont(new Font("Sans Serif", Font.PLAIN, DisplayFrame.FONT_SIZE / 2));
		cityLabel.setFont(new Font("Sans Serif", Font.PLAIN, DisplayFrame.FONT_SIZE / 2));
		postLabel.setFont(new Font("Sans Serif", Font.PLAIN, DisplayFrame.FONT_SIZE / 2));
		// Data in the center
		...
		String[] columnTitlesPatients = { "ID", "Title", "First Name", "Last Name", "Date Of Birth", "Telephone",
				"Actions" };
		...
		patientsLabel.setFont(new Font("Sans Serif", Font.BOLD, DisplayFrame.FONT_SIZE));
	...
	/**
	 * Function used to convert an ArrayList of patients to a 2D array needed by
	 * JTable component
	 * 
	 * @param givenList
